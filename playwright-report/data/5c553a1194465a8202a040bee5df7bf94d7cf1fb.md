...
- Name: auth/sign-up.spec.js >> Sign Up >> should sign up with valid email and password
- Location: tests/auth/sign-up.spec.js:11:7
...
Expected pattern: /\/registration\/check_email/
Received string:  "http://localhost:3000/registration/new"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    9 × unexpected value "http://localhost:3000/registration/new"
    ...
    - generic [ref=e21]:
      - generic [ref=e22]:
        ...
        - textbox "Email" [ref=e24]:
          - /placeholder: E-mail...
          - text: test-1779808736510@example.com
      - generic [ref=e25]:
